 ...
 * @author eguid
 */
public class MainScene extends ViewTemplate {
	...
	private void initView() {
		...
		String dropChess="file:/"+LaunchUtil.getCuPath()+LaunchUtil.getPrams(this,"dropChess");
		String background="file:/"+LaunchUtil.getCuPath()+LaunchUtil.getPrams(this,"background");
		String win="file:/"+LaunchUtil.getCuPath()+LaunchUtil.getPrams(this,"win");
