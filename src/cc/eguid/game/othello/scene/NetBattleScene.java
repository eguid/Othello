 ...
 * @author eguid
 */
public class NetBattleScene extends ViewTemplate {

	final Logger log = Logger.getLogger("网络对战主界面");
	...
	@Override
	public void load() {
		initWindow("奥赛罗（黑白棋） - 网络对战模式 - eguid作品", 1100, 680);
		// 初始化操作
		initView();// 创建界面元素
	}
